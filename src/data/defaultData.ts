...
export const DEFAULT_STUDENTS: Student[] = [
  { id: 'hs_01', stt: 1, name: 'Nguyễn An Khang', gender: 'Nam', role: 'Lớp trưởng', parentName: 'Nguyễn Văn Minh', parentPhone: '0912345601' },
  { id: 'hs_02', stt: 2, name: 'Trần Bảo Châu', gender: 'Nữ', role: 'Lớp phó học tập', parentName: 'Trần Văn Long', parentPhone: '0912345602' },
  { id: 'hs_03', stt: 3, name: 'Lê Tuấn Anh', gender: 'Nam', role: 'Lớp phó kỷ luật', parentName: 'Lê Văn Tuấn', parentPhone: '0912345603' },
  { id: 'hs_04', stt: 4, name: 'Phạm Minh Đức', gender: 'Nam', role: 'Lớp phó lao động', parentName: 'Phạm Đức Hòa', parentPhone: '0912345604' },
  { id: 'hs_05', stt: 5, name: 'Hoàng Thị Mai', gender: 'Nữ', role: 'Cán sự bộ môn', parentName: 'Hoàng Văn Thắng', parentPhone: '0912345605' },
  { id: 'hs_06', stt: 6, name: 'Vũ Đức Nam', gender: 'Nam', role: 'Học sinh', parentName: 'Vũ Văn Bách', parentPhone: '0912345606' },
  { id: 'hs_07', stt: 7, name: 'Đặng Thùy Dương', gender: 'Nữ', role: 'Học sinh', parentName: 'Đặng Văn Cường', parentPhone: '0912345607' },
  { id: 'hs_08', stt: 8, name: 'Bùi Gia Huy', gender: 'Nam', role: 'Học sinh', parentName: 'Bùi Văn Sang', parentPhone: '0912345608' },
  { id: 'hs_09', stt: 9, name: 'Ngô Thanh Hà', gender: 'Nữ', role: 'Học sinh', parentName: 'Ngô Quốc Trung', parentPhone: '0912345609' },

  { id: 'hs_10', stt: 10, name: 'Đỗ Quốc Bảo', gender: 'Nam', role: 'Cán sự bộ môn', parentName: 'Đỗ Hùng Dũng', parentPhone: '0912345610' },
  { id: 'hs_11', stt: 11, name: 'Nguyễn Phương Linh', gender: 'Nữ', role: 'Cán sự bộ môn', parentName: 'Nguyễn Văn Đạt', parentPhone: '0912345611' },
  { id: 'hs_12', stt: 12, name: 'Lê Hoàng Nam', gender: 'Nam', role: 'Học sinh', parentName: 'Lê Văn Trọng', parentPhone: '0912345612' },
  { id: 'hs_13', stt: 13, name: 'Phan Khánh Vy', gender: 'Nữ', role: 'Học sinh', parentName: 'Phan Văn Hải', parentPhone: '0912345613' },
  { id: 'hs_14', stt: 14, name: 'Trương Tuấn Kiệt', gender: 'Nam', role: 'Học sinh', parentName: 'Trương Văn Nghĩa', parentPhone: '0912345614' },
  { id: 'hs_15', stt: 15, name: 'Võ Minh Quân', gender: 'Nam', role: 'Học sinh', parentName: 'Võ Văn Hưng', parentPhone: '0912345615' },
  { id: 'hs_16', stt: 16, name: 'Dương Thảo Nhi', gender: 'Nữ', role: 'Học sinh', parentName: 'Dương Văn Bình', parentPhone: '0912345616' },
  { id: 'hs_17', stt: 17, name: 'Lý Gia Hưng', gender: 'Nam', role: 'Học sinh', parentName: 'Lý Quốc Bảo', parentPhone: '0912345617' },
  { id: 'hs_18', stt: 18, name: 'Nguyễn Ngọc Anh', gender: 'Nữ', role: 'Học sinh', parentName: 'Nguyễn Văn Tiến', parentPhone: '0912345618' },

  { id: 'hs_19', stt: 19, name: 'Hồ Tấn Phát', gender: 'Nam', role: 'Cán sự bộ môn', parentName: 'Hồ Văn Lộc', parentPhone: '0912345619' },
  { id: 'hs_20', stt: 20, name: 'Trịnh Cẩm Tú', gender: 'Nữ', role: 'Cán sự bộ môn', parentName: 'Trịnh Văn Hùng', parentPhone: '0912345620' },
  { id: 'hs_21', stt: 21, name: 'Lê Văn Tuấn Anh', gender: 'Nam', role: 'Học sinh', parentName: 'Lê Văn Cảnh', parentPhone: '0912345621' },
  { id: 'hs_22', stt: 22, name: 'Đoàn Quang Khải', gender: 'Nam', role: 'Học sinh', parentName: 'Đoàn Văn Sơn', parentPhone: '0912345622' },
  { id: 'hs_23', stt: 23, name: 'Mai Tuyết Nhung', gender: 'Nữ', role: 'Học sinh', parentName: 'Mai Văn Tùng', parentPhone: '0912345623' },
  { id: 'hs_24', stt: 24, name: 'Đinh Quốc Việt', gender: 'Nam', role: 'Học sinh', parentName: 'Đinh Văn Hoàng', parentPhone: '0912345624' },
  { id: 'hs_25', stt: 25, name: 'Lâm Mỹ Duyên', gender: 'Nữ', role: 'Học sinh', parentName: 'Lâm Văn Phước', parentPhone: '0912345625' },
  { id: 'hs_26', stt: 26, name: 'Cao Đình Trọng', gender: 'Nam', role: 'Học sinh', parentName: 'Cao Văn Hạnh', parentPhone: '0912345626' },
  { id: 'hs_27', stt: 27, name: 'Nguyễn Thảo Nguyên', gender: 'Nữ', role: 'Học sinh', parentName: 'Nguyễn Văn Phúc', parentPhone: '0912345627' },

  { id: 'hs_28', stt: 28, name: 'Phùng Hải Đăng', gender: 'Nam', role: 'Cán sự bộ môn', parentName: 'Phùng Văn Lâm', parentPhone: '0912345628' },
  { id: 'hs_29', stt: 29, name: 'Chu Quỳnh Trang', gender: 'Nữ', role: 'Học sinh', parentName: 'Chu Văn Quý', parentPhone: '0912345629' },
  { id: 'hs_30', stt: 30, name: 'Tạ Minh Triết', gender: 'Nam', role: 'Học sinh', parentName: 'Tạ Văn Tuấn', parentPhone: '0912345630' },
  { id: 'hs_31', stt: 31, name: 'Vương Bảo Trâm', gender: 'Nữ', role: 'Học sinh', parentName: 'Vương Văn Nam', parentPhone: '0912345631' },
  { id: 'hs_32', stt: 32, name: 'Nguyễn Hoàng Nam', gender: 'Nam', role: 'Học sinh', parentName: 'Nguyễn Văn Thành', parentPhone: '0912345632' },
  { id: 'hs_33', stt: 33, name: 'Trần Hoài An', gender: 'Nữ', role: 'Học sinh', parentName: 'Trần Quốc Tuấn', parentPhone: '0912345633' },
  { id: 'hs_34', stt: 34, name: 'Lương Kiến Quốc', gender: 'Nam', role: 'Học sinh', parentName: 'Lương Văn Thái', parentPhone: '0912345634' },
  { id: 'hs_35', stt: 35, name: 'Dương Yến Nhi', gender: 'Nữ', role: 'Học sinh', parentName: 'Dương Văn Chiến', parentPhone: '0912345635' },
  { id: 'hs_36', stt: 36, name: 'Tạ Hoàng Bách', gender: 'Nam', role: 'Học sinh', parentName: 'Tạ Văn Duy', parentPhone: '0912345636' },
];
...
export const INITIAL_BEHAVIOR_RECORDS: BehaviorRecord[] = [
  ...
  },
  {
    ...
    category: 'quen_bai',
    pointsImpact: -2,
    educationalMeasure: 'Nhắc nhở, giao bạn cán sự môn kiểm tra vở',
    severity: 'nhe',
    weekNumber: 3,
    semester: 1,
    month: 9,
...
export const SAMPLE_WEEK_4_REPORT: WeeklyReport = {
  ...
  studentWeeklyIndicators: [
    ...
    { index: 8, title: 'Việc tốt / Tuyên dương', count: 1, details: 'Cả lớp chăm sóc bồn hoa sạch đẹp' },
...
Do số lần vi phạm đã vượt mức quy định của lớp, Thầy/Cô rất mong gia đình dành thời gian trò chuyện, nhắc nhở thêm tại nhà để tháng tới em chấn chỉnh nề nếp, tránh làm ảnh hưởng đến kết quả rèn luyện định kỳ của em. Thầy/Cô cảm ơn sự phối hợp của gia đình ạ!`
  ...
  scnJournalEntries: [
    ...
    },
    {
      ...
      educationalMeasure: 'Nhắc nhở trên lớp, giao bạn cán sự kiểm tra vở đầu giờ (Mức 1 lỗi tháng: chưa gửi tin PH)'
    },
    {
      date: '15/09/2026',
      studentName: 'Lê Hoàng Nam',
...
export const DEFAULT_SYSTEM_PROFILE: SystemProfile = {
  ...
  officers: {
    ...
    studyLeader: 'Lê Hoàng Long',
    disciplineLeader: 'Vũ Minh Anh',
  },
